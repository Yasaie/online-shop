...
class DictionaryTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $array = [
            ...
            # App\Seller
            ['language_id' => 'fa', 'context_id' => 1, 'context_type' => 'App\Seller', 'key' => 'service', 'value' => 'صورتی + گارانتی آراد'],
            ['language_id' => 'en', 'context_id' => 1, 'context_type' => 'App\Seller', 'key' => 'service', 'value' => 'Pink + Arad Warranty'],
