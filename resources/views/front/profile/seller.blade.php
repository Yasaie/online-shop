                        ...
                        <div class="row seller" >
                            ...
                            <form class="col-lg-5 seller_form">
                                                        ...
                                                        <div class="form-check">
                                                                ...
                                                                <div class="radio">
                                                                    <label><input onchange="show_form()"  value="company"  type="radio" name="business" ><span><i class="fa fa-address-card" aria-hidden="true"></i>
                                                                        شخص حقوقی</span></label>
                                                                    <label><input onchange="show_form()"  value="personal"   type="radio" name="business" checked ><span> <i class="fa fa-user-o" aria-hidden="true"></i>
                                                        ...
                                                        <div class="personal_info row">
                                                                <label for="">نام</label>
                                                                <input type="text" class="form-control" name="lname" id="" aria-describedby="emailHelpId" placeholder="">

                                                                <label for="">نام خانوادگی</label>
                                                                <input type="text" class="form-control" name="fname" id="" aria-describedby="emailHelpId" placeholder="">
                                                        </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div id="loadFileXml" class="btn bg-success"  onclick="document.getElementById('file').click();" >
