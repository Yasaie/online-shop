...
@section('body')
    ...
    <br><br>
    <hr><h4>@lang('product.description')</h4>
    <div>{!! $product->description !!}</div>

    @if($product_details)
        <br><br>
        <hr><h4>@lang('product.specification')</h4>
    ...
    <br><br>
    <hr><h4>@lang('product.comments')</h4>
